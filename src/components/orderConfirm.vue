...
<script>
  ...
  export default{
    ...
    computed: {
      ...
      orderNum() {
        return this.shipping + this.priceAll - this.discount + this.tax;
      }
    },
    components: {
      Modal,
